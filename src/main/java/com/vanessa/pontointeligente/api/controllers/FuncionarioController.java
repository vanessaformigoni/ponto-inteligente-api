...
import com.vanessa.pontointeligente.api.dtos.FuncionarioDto;
...
public class FuncionarioController {
	 ...
	 */
	@PutMapping(value = "/{id}") // requisição via id
	ResponseEntity<Response<FuncionarioDto>> atualizar(@PathVariable("id") Long id,
			@Valid @RequestBody FuncionarioDto funcionarioDto, BindingResult result) throws NoSuchAlgorithmException {
		log.info("Atualizando os dados do funcionario: ", funcionarioDto.toString());
	...
	private void atualizarDadosFuncionario(Funcionario funcionario, FuncionarioDto funcionarioDto,
		...
		funcionarioDto.getQtdHorasAlmoco().ifPresent(qtd -> funcionario.setQtdHorasAlmoco(Float.valueOf(qtd)));
